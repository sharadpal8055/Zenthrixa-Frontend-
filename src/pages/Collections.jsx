      ...
      <div className="flex-1">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
          ...
          <div className="relative group self-end md:self-auto">
            <select className="appearance-none border-2 border-gray-100 text-gray-600 text-xs sm:text-sm font-medium px-4 py-2.5 pr-10 rounded-xl outline-none focus:border-indigo-500 transition-all cursor-pointer bg-white shadow-sm">
